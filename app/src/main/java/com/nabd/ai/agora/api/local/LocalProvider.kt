package com.nabd.ai.agora.api.local

import com.nabd.ai.agora.api.*

import android.content.Context
import com.nabd.ai.agora.util.DebugLog
import com.nabd.ai.agora.api.util.ThinkingParser
...
class LocalProvider(
    ...
    private suspend fun ensureEngineLoaded(model: com.nabd.ai.agora.data.LocalChatModelConfig): LlamaChatEngine? {
